...
void ArithmeticLogicUnit::STR(const std::string& r1, std::string a1) {
...
void ArithmeticLogicUnit::STR(const std::string& r1, const std::string& a1, const std::string& shift) {
